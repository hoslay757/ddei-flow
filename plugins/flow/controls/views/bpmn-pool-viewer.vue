...
export default {
  name: "ddei-flow-bpmn-viewer-pool",
  props: {
    model: {
      type: Object,
      default: null
...
<template>
  <div ref="divElement" class="ddei-flow-bpmn-viewer-pool">
    <div class="title">
      <svg class="icon-ddei-flow" aria-hidden="true">
        <use xlink:href="#icon-ddei-flow-business-pool"></use>
      </svg>
      <div class="text">
        {{ model.name ? model.name : "Pool" }}
      </div>
    </div>
    <div class="desc">
      {{ model.text }}
