<template>
  <div class="ddei-flow-element-setting-panel" v-if="model && forceRefresh">
    <div class="content">
      <div v-for="item in options?.items" style="display: contents;">
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-bpmnsubtype' && validItemCondition(item) && bpmnSubTypeDataSource?.length > 0">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-dataobject-setting' && model.bpmnType == 'DataObject' && validItemCondition(item)">
          <div class="change-bpmn-sub-type">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-dataobject-setting' && model.bpmnType == 'DataObject' && model.dataType == 8 && validItemCondition(item)">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-time-setting' && ((model.bpmnType == 'StartEvent' && model.bpmnSubType == 3) || (model.bpmnType == 'IntermediateCatchEvent' && (model.bpmnSubType == 1 || !model.bpmnSubType)) || (model.bpmnType == 'BoundaryEvent' && model.bpmnSubType == 2)) && validItemCondition(item)">
          <div class="change-bpmn-sub-type">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-time-setting' && model.timeType != 'timeDuration' && model.timeType != 'CRON' && ((model.bpmnType == 'StartEvent' && model.bpmnSubType == 3) || (model.bpmnType == 'IntermediateCatchEvent' && (model.bpmnSubType == 1 || !model.bpmnSubType)) || (model.bpmnType == 'BoundaryEvent' && model.bpmnSubType == 2)) && validItemCondition(item)">
          <div class="change-property-text" :title="item.desc">
            <div class="change-property-text-title">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-time-setting' && model.timeType == 'timeDuration' && ((model.bpmnType == 'StartEvent' && model.bpmnSubType == 3) || (model.bpmnType == 'IntermediateCatchEvent' && (model.bpmnSubType == 1 || !model.bpmnSubType)) || (model.bpmnType == 'BoundaryEvent' && model.bpmnSubType == 2)) && validItemCondition(item)">
          <div class="change-property-text" :title="item.desc">
            <div class="change-property-text-title">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-time-setting' && model.timeType == 'CRON' && ((model.bpmnType == 'StartEvent' && model.bpmnSubType == 3) || (model.bpmnType == 'IntermediateCatchEvent' && (model.bpmnSubType == 1 || !model.bpmnSubType)) || (model.bpmnType == 'BoundaryEvent' && model.bpmnSubType == 2)) && validItemCondition(item)">
          <div class="change-property-text" :title="item.desc">
            <div class="change-property-text-title">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-escal-setting' && ((model.bpmnType == 'StartEvent' && model.bpmnSubType == 8) || (model.bpmnType == 'EndEvent' && model.bpmnSubType == 5) || (model.bpmnType == 'BoundaryEvent' && model.bpmnSubType == 7) || (model.bpmnType == 'IntermediateThrowEvent' && model.bpmnSubType == 6)) && validItemCondition(item)">
          <div class="change-property-text" :title="item.desc">
            <div class="change-property-text-title">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-error-setting' && ((model.bpmnType == 'StartEvent' && model.bpmnSubType == 9) || (model.bpmnType == 'IntermediateEvent' && model.bpmnSubType == 27) || (model.bpmnType == 'EndEvent' && model.bpmnSubType == 6) || (model.bpmnType == 'BoundaryEvent' && model.bpmnSubType == 4)) && validItemCondition(item)">
          <div class="change-property-text" :title="item.desc">
            <div class="change-property-text-title">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-condition-setting' && ((model.bpmnBaseType == 'Sequence' && model.bpmnSubType == 2) || (model.bpmnType == 'StartEvent' && model.bpmnSubType == 4) || (model.bpmnType == 'StartEvent' && model.bpmnSubType == 4) ) && validItemCondition(item)">
          <div class="change-property-text" :title="item.desc">
            <div class="change-property-text-title">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-linetype' && validItemCondition(item) && lineTypeDataSource?.length > 0">
          <div class="change-bpmn-sub-type">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-linepointtype' && validItemCondition(item) && model?.bpmnSubType == 5 && startPointTypeDataSource?.length > 0">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-linepointtype' && validItemCondition(item) && model?.bpmnBaseType == 'Sequence'">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-linepointtype' && validItemCondition(item) && model?.bpmnSubType == 5 && endPointTypeDataSource?.length > 0">
          <div class="change-point-type">
            <div class="change-point-type-title">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-callactivity-review' && validItemCondition(item) && model?.bpmnType == 'CallActivityTask'">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-activity-labels' && validItemCondition(item) && model?.bpmnType == 'DataStore'">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-activity-labels' && validItemCondition(item) && model.bpmnType == 'SubProcess' && model.bpmnSubType == 4">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-activity-labels' && validItemCondition(item) && (model.bpmnType == 'SubProcess' || model.bpmnType == 'ChoreographySubProcess')">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-activity-labels' && validItemCondition(item) && model?.bpmnBaseType == 'Activity'">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-activity-labels' && validItemCondition(item) && model?.bpmnBaseType == 'Activity' && model?.multiInstance == 1">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-activity-labels' && validItemCondition(item) && model.bpmnType == 'ChoreographySubProcess'">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-change-activity-labels' && validItemCondition(item) && model?.bpmnType == 'DataObject'">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-property-editor-text' && validItemCondition(item)">
          <div class="change-property-text" :title="item.desc">
            <div class="change-property-text-title">
        ...
        <div class="row"
          v-if="model && !item.viewer && item.id == 'ddei-flow-property-editor-textarea' && validItemCondition(item) ">
...
export default {
  name: "ddei-flow-element-setting-panel",
  mixins: [],
  props: {
    //外部传入的插件扩展参数
    options: {
...
.ddei-flow-element-setting-panel {
  width: 100%;
